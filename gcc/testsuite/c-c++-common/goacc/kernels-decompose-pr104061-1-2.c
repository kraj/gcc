...
#pragma acc kernels /* { dg-line l_compute1 } */
  ...
  /* { dg-bogus {note: OpenACC 'kernels' decomposition: variable 'k' declared in block requested to be made addressable} {w/ debug} { xfail c++26 } l_compute1 } */
  /* { dg-bogus {note: variable 'k' made addressable} {w/ debug} { xfail c++26 } l_compute1 } */
  ...
  {
    /* { dg-bogus {note: beginning 'gang-single' part in OpenACC 'kernels' region} {w/ debug} { target c++23_down } .-1 }
    /* { dg-bogus {note: beginning 'gang-single' part in OpenACC 'kernels' region} {w/ debug} { xfail c++26 } .-2 }
